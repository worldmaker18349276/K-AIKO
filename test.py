...
# test
# beatmap = Beatmap(None, [Beat.Loud(1.0 + t*0.5) for t in range(16)])
# level = IncrLevel()
# beatmap = Beatmap(None, [Beat.Soft(1.0), Beat.Loud(1.5, -0.5), Beat.Soft(2.0), Beat.Soft(2.25), Beat.Loud(2.5, 0.5),
...
beatmap = Beatmap(song, from_pattern(offset, 60.0/bpm, beats))
